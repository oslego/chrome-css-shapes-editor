...
function($, markup, CSSUtils){
    ...
    describe('CSSUtils', function(){
        ...
        describe('Supported unit types', function(){
           it ('should expose array of unit types', function(){
             var units = ["px", "in", "cm", "mm", "pt", "pc", "em", "rem", "vw", "vh", "%"];
             expect(CSSUtils.units).toEqual(units);
           });
        });
